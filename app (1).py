...
USERS = {
    'admin':   os.environ.get('PASS_ADMIN',   'rmgc2024'),
    'manager': os.environ.get('PASS_MANAGER', 'golf2024'),
    'staff':   os.environ.get('PASS_STAFF',   'staff2024'),
}
